            ...
            WebView(
              ...
              onPageStarted: (String url) {
                ...
                if(url == '${AppConstants.BASE_URL}/success'){
                  Navigator.pushReplacement(context, MaterialPageRoute(builder: (_) => OrderSuccessfulScreen(orderID: widget.orderModel.id.toString(), status: 0)));
                }else if(url == '${AppConstants.BASE_URL}/fail') {
                  Navigator.pushReplacement(context, MaterialPageRoute(builder: (_) => OrderSuccessfulScreen(orderID: widget.orderModel.id.toString(), status: 1)));
                }else if(url == '${AppConstants.BASE_URL}/cancel') {
                  Navigator.pushReplacement(context, MaterialPageRoute(builder: (_) => OrderSuccessfulScreen(orderID: widget.orderModel.id.toString(), status: 2)));
                }
              },
